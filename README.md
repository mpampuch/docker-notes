...
> 
> So later when you properly run this application inside a Docker container, you know that you should map a port on the host to port 3000 on the container. 

> [!TIP]
> You can map a port on the host to the port on these containers in the 
Dockerfile.
